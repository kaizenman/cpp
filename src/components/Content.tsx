    ...
    <div data-bs-theme={theme} >
      <div>
          <div className="row d-flex">
            <div className="fixed d-flex flex-row justify-content-between">
              <div>
              ...
              <Container>
                ...
                {activeArticle.chapters.map(chapter => 
                  <Container key={chapter.id}>
                    <h2 className="mt-4 text-capitalize">{chapter.title}</h2>
                    ...
                    {chapter.subChapters && chapter.subChapters.map(subChapter => 
                      <div key={subChapter.id}>
                        <h3 className="mt-3 text-capitalize">{subChapter.title}</h3>
                        <p className="mt-3 text-break">{subChapter.content}</p>
                        {subChapter.codeSnippet && <code>{subChapter.codeSnippet}</code> }
                        {subChapter.challenges && <Practice theme={theme} challenges={subChapter.challenges} /> }
                        <br />
                      </div>
                    )}
                  </Container>)}
